...
?>The winner is of this contest chosen at random by a registered member of NSB from all the entries on instagram.<br />You do not have to be a registered member of NSB to win.<br />
 We do this to make the possibility of being selected based on two factors:<br /><br />
1) the server (NSB) randomly selecting an entry<br /> 2) the randomness of a member activating the script.<br /><br /><?
